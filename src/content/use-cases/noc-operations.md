...
hero:
  ...
  title: Network Operations Center Optimization
  description: Your NOC is drowning in alerts from five different monitoring tools. Most are noise. The critical ones are buried. Quatro consolidates any vendor's data into one source of operational truth.
  primaryCta:
...
capabilities:
  ...
  - name: Intelligent Alert Correlation
    description: Machine learning learns which alerts are related. Suppress noise, elevate true incidents. Reduce alert volume by 80% while catching critical events. Governed autonomous action identifies and routes incidents without manual intervention.
    icon: brain
...
objections:
  - concern: Our vendors don't expose their APIs or alert data. How do we get data out of locked vendor platforms?
