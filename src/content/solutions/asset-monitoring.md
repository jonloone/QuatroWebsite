...
capabilities:
  ...
  - name: "Predictive Maintenance"
    description: "AI models forecast equipment failures 2-4 weeks in advance using vibration, thermal, and multi-sensor correlation."
  ...
  - name: "Anomaly Detection"
    description: "Predictive intelligence that learns operational baselines and catches issues that single-threshold alarms miss entirely."
...
platformMapping:
  ...
  operate: "AI analytics engine forecasts equipment degradation 2-4 weeks before failure using vibration, thermal, and multi-sensor correlation. Real-time operational models enable what-if analysis."
