...
proofPoint:
  ...
  metrics:
    ...
    - value: "Production"
      label: "Verified"
  narrative: "Claims Classification has been built and demonstrated for Lloyds Banking Group's insurance and pensions division, with ML models that attach accept/reject predictions and confidence scores to each incoming claim."
cta:
  primary:
    label: "Schedule an Insurance Assessment"
    href: "/contact/demo"
