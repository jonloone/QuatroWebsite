...
stats:
  ...
  - value: "<3 min"
    label: "De Detección a Despacho"
  - value: "0.5%"
    label: "Sensibilidad de Flujo"
  - value: "3,500+ km"
    label: "Cobertura de Ductos"
challenges:
  - title: "Dominios de Detección Fragmentados"
    description: "La detección de fugas, la seguridad física y SCADA operan de forma independiente sin correlación cruzada. Se pierde tiempo crítico de respuesta alternando entre sistemas."
  - title: "Sobrecarga de Falsos Positivos"
    description: "La detección por método único genera tasas de falsas alarmas del 50-80%. La fatiga de alarmas incrementa el riesgo de que eventos genuinos sean descartados."
  - title: "Puntos Ciegos en Terreno Remoto"
    description: "Los corredores de ductos cruzan desiertos, montañas y tundra donde el monitoreo físico continuo es impracticable y los ciclos de patrullaje dejan brechas."
  - title: "Flujos de Respuesta Desconectados"
...
proofPoint:
  ...
  metrics:
    ...
    - value: "2 FTE"
      label: "Reasignados"
  narrative: "Un operador midstream con 3,500 km de ductos reemplazó su RTTM legacy y plataformas separadas de seguridad física. La fusión multimétodo con IA redujo las falsas alarmas de más de 200/mes a ~50, y los playbooks automatizados redujeron el tiempo de detección a despacho de 22 minutos a menos de 3 minutos."
cta:
  primary:
    label: "Solicite una Evaluación de Ductos"
    href: "/es/contact/demo"
  secondary:
    label: "Hable con un Ingeniero de Ductos"
    href: "/es/contact/sales"
  microcopy: "Evaluación típica: 30-45 minutos. Mapearemos sus sistemas actuales de detección de fugas y seguridad y le mostraremos cómo la fusión multimétodo con IA elimina las falsas alarmas."
---
